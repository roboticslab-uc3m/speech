...
bool LlamaGPT_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="model")
    {
        paramValue = m_model;
    ...
    if (paramName =="tokens")
    {
        paramValue = std::to_string(m_tokens);
        return true;
    }
    if (paramName =="prompt")
    {
    ...
    if (paramName =="promptFile")
    {
        paramValue = m_promptFile;
        return true;
    }
    if (paramName =="print")
    {
        if (m_print==true) paramValue = "true";
...
std::string LlamaGPT_ParamsParser::getConfiguration() const
{
